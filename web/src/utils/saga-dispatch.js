...
//
// This function wraps redux-saga's `put.resolve` effect, and swallows all errors,
// re-throwing them from a separate stack frame instead. This serves two purposes:
//
